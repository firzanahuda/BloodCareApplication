        ...
        buttonReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!username.isEmpty() && !password.isEmpty()){
                    ...
                    buttonReset.setBackgroundResource(R.drawable.squaremaroon);
                ...
                if(!username.equals("") && !password.equals("")&& !forgotPassword.equals("")) {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            PutData putData = new PutData("http://192.168.8.122/bloodcareapplication/forgotpassword.php", "POST", field, data);
                            if (putData.startPut()) {
